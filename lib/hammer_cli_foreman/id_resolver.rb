module HammerCLIForeman
  ...
  class Searchables
    ...
    SEARCHABLES = {
      ...
      # :image =>            [],
      :interface =>        [],
      :location =>         [ s_name(_("Location name")), s("title", _("Location title"), :editable => false), s("id", _("Location id")) ],
      :medium =>           [ s_name(_("Medium name")) ],
      :model =>            [ s_name(_("Model name")) ],
      :organization =>     [ s_name(_("Organization name")), s("title", _("Organization title"), :editable => false), s('id', _("Organization id"))],
