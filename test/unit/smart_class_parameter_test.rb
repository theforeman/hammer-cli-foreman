...
describe HammerCLIForeman::SmartClassParameter do
  ...
  context "AddMatcherCommand" do
    ...
    context "parameters" do
      it_should_accept "smart-class-parametr-id, match, value",
                       ["--smart-class-parameter-id=1", "--match='domain=my.lan'", "--value=1"]
      it_should_accept "smart-class-parameter, puppet-class, match, value",
                       ["--smart-class-parameter=par", "--puppet-class=ntp", "--match='domain=my.lan'", "--value=1"]
      it_should_fail_with "smart-class-parameter, match, value",
                          ["--smart-class-parameter=par", "--match='domain=my.lan'", "--value=1"]
    end
  end
  ...
  context "RemoveMatcherCommand" do
    ...
    context "parameters" do
      ...
      it_should_accept "smart-class-parameter, puppet-class, id",
                       ["--smart-class-parameter=par", "--puppet-class=ntp", "--id=1"]
