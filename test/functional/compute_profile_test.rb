...
describe "parameters" do
  ...
  describe "set attributes" do
    before do
      @cmd = ["compute-profile", "attribute" , "create"]
    end
  ...
  describe "update-attributes" do
    before do
      @cmd = ["compute-profile", "attribute", "update"]
      @compute_profile =
        {
          "id" => 1,
          "name" => "profile2",
  ...
  describe "add-volume" do
    before do
      @cmd = ["compute-profile", "attribute" , "add-volume"]
      @compute_profile =
        {
          "id" => 1,
          "name" => "profile2",
  ...
  describe "update-volume" do
      before do
        @cmd = ["compute-profile", "attribute", "update-volume"]
        @compute_profile =
          {
            "id" => 1,
            "name" => "profile2",
  ...
  describe "remove-volume" do
    before do
      @cmd = ["compute-profile", "attribute", "remove-volume"]
      @compute_profile =
        {
          "id" => 1,
          "name" => "profile2",
  ...
  describe "add-interface" do
    before do
      @cmd = ["compute-profile", "attribute" , "add-interface"]
      @compute_profile =
        {
          "id" => 1,
          "name" => "profile2",
  ...
  describe "update-interface" do
    before do
      @cmd = ["compute-profile", "attribute" , "update-interface"]
      @compute_profile =
        {
          "id" => 1,
          "name" => "profile2",
  ...
  describe "remove-interface" do
    before do
      @cmd = ["compute-profile", "attribute", "remove-interface"]
      @compute_profile =
        {
          "id" => 1,
          "name" => "profile2",
